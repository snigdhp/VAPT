...
![alt text](../image/Hijack_Session.md/image.png)
...
![alt text](../image/Hijack_Session.md/image-1.png)
...
![alt text](../image/Hijack_Session.md/image-2.png)
![alt text](../image/Hijack_Session.md/image-3.png)


- Now copy the new session cookie and paste it on Request body and sent this request to intruder 
![alt text](../image/Hijack_Session.md/image-4.png)
...
![alt text](../image/Hijack_Session.md/image-5.png)
![alt text](../image/Hijack_Session.md/image-6.png)
![alt text](../image/Hijack_Session.md/image-7.png)
