...
![[Pasted image 20241122121802.png]]
...
![[Pasted image 20241122122001.png]] 
...
![[Pasted image 20241122133738.png]]
...
![[Pasted image 20241122140319.png]]
...
## Sublist3r
Sublister is python tool design to  enumerate subdomain of website OSINT.

``` bash
pyhton sublit3r.py -d <url.com> -b -t 50 -p- -e google,yahoo 
```

![[Pasted image 20241122152046.png]]
...
```bash 
theHarvester -d <url.com> -b <search engin you want to search>
```
...
![[Pasted image 20241122175317.png]]
